...
# def run_set_name(cmd: str, out: Callable[[str], None], main: Callable[[str], None]) -> None:
#     e2c = E2c[str, str]()
#
#     e2c.actor('show_room', run_show)
#     e2c.actor('set_room_name', lambda x, out: out(x + 'xxx'))
#     e2c.actor('main', lambda x: main(''))
#
#     e2c.configure_by_file(folder + '/config/room/set_room_name.e2c')
#     e2c.visualize('components/graphviz/room')
#
#     e2c.run_continues(cmd, out)
